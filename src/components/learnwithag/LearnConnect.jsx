                ...
                <div className="row g-0">
                    ...
                    <div className="col-lg-8">
                        <div className="cocard learncard">
                            <h1>Why I Started This</h1>
                            <p>When I started my journey, I didn’t have anyone to decode <br /> the “real” side of building.</p>
                            <p>Everyone spoke about success, but no one about survival.</p>
                            <p>So, I decided to share what I wished someone told me back <br /> then not as a mentor, but as a mirror.</p>
